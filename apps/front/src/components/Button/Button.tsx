  ...
  Plus: (
    ...
    Lens: (
      <svg 
        ...
        fill="none" 
        xmlns="http://www.w3.org/2000/svg">
          <rect width="2" height="2" transform="matrix(-1 0 0 1 9 1)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 7 1)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 5 3)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 3 5)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 3 7)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 5 9)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 7 11)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 9 11)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 11 9)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 13 7)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 13 5)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 11 3)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 13 11)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 15 13)" fill="white"/>
          <rect width="2" height="2" transform="matrix(-1 0 0 1 17 15)" fill="white"/>
      </svg>
    ),
    Chat: (
