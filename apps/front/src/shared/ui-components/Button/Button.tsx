...
const Icons: { [key in IconKey]: ReactElement } = {
  ...
  Wrench: (
    <svg
      ...
      fill="none"
    >
      <rect x="11" y="1.5" width="2" height="2" fill="#49317B" />
      <rect x="9" y="1.5" width="2" height="2" fill="#49317B" />
      <rect x="7" y="5.5" width="2" height="2" fill="#49317B" />
      <rect x="7" y="7.5" width="2" height="2" fill="#49317B" />
      <rect x="5" y="9.5" width="2" height="2" fill="#49317B" />
      <rect x="3" y="11.5" width="2" height="2" fill="#49317B" />
      <rect x="9" y="7.5" width="2" height="2" fill="#49317B" />
      <rect x="11" y="9.5" width="2" height="2" fill="#49317B" />
      <rect x="9" y="9.5" width="2" height="2" fill="#49317B" />
      <rect x="7" y="11.5" width="2" height="2" fill="#49317B" />
      <rect x="5" y="13.5" width="2" height="2" fill="#49317B" />
      <rect x="3" y="15.5" width="2" height="2" fill="#49317B" />
      <rect x="1" y="13.5" width="2" height="2" fill="#49317B" />
      <rect x="1" y="15.5" width="2" height="2" fill="#49317B" />
      <rect x="3" y="13.5" width="2" height="2" fill="#49317B" />
      <rect x="5" y="11.5" width="2" height="2" fill="#49317B" />
      <rect x="7" y="9.5" width="2" height="2" fill="#49317B" />
      <rect x="13" y="9.5" width="2" height="2" fill="#49317B" />
      <rect x="15" y="5.5" width="2" height="2" fill="#49317B" />
      <rect x="15" y="7.5" width="2" height="2" fill="#49317B" />
      <rect x="7" y="3.5" width="2" height="2" fill="#49317B" />
    </svg>
  ),
  Arrow: (
    <svg
