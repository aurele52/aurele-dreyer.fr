...
export default function CreateCustom(props: createCustomProps) {
  ...
  const setAbsoluteValue = () => {
    setAbsoluteGameInfo(() => ({
      ...relativeGameInfo,
      barLarge: (relativeGameInfo.barLarge * relativeGameInfo.gamexsize) / 100,
      menuSize: (relativeGameInfo.menuSize * relativeGameInfo.gameysize) / 100,
      numberSize:
      ...
      numberTopDist:
        (relativeGameInfo.numberTopDist *
          Math.min(relativeGameInfo.gamexsize, relativeGameInfo.gameysize)) /
        100,
      numberSideDist:
      ...
      barSize: (relativeGameInfo.barSize * relativeGameInfo.gameysize) / 100,
      barDist: (relativeGameInfo.barDist * relativeGameInfo.gamexsize) / 100,
      barSpeed: (relativeGameInfo.barSpeed * relativeGameInfo.gamexsize) / 100,
    }));
  };
    ...
    <div className="create-custom">
      <div className="header-createcustom">
        <div className="tabs-header-createcustom">
          <Button color="purple" content="GAME" onClick={GameDisplayOnClick} />
          <Button
            color="purple"
            content="INTERFACE"
        ...
        <div className="preview-header-createcustom">
          <Button color="pink" content="PREVIEW" onClick={PreviewOnClick} />
        </div>
      </div>
      {interfaceDisplay === true && (
        <div className="body-custom custom-scrollbar lilac-list">
          <ColorSelector
            name={"oneBarColor"}
      ...
      <div className="footer-createcustom">
        <Button color="red" content="GO BACK" onClick={props.returnToMenu} />
